...
public class AssignmentPersistenceImpl
	...
	private static final String _FILTER_SQL_SELECT_ASSIGNMENT_WHERE =
		"SELECT DISTINCT {assignment.*} FROM FOO_Assignment assignment WHERE ";

	private static final String
		_FILTER_SQL_SELECT_ASSIGNMENT_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {FOO_Assignment.*} FROM (SELECT DISTINCT assignment.assignmentId FROM FOO_Assignment assignment WHERE ";

	private static final String
		_FILTER_SQL_SELECT_ASSIGNMENT_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN FOO_Assignment ON TEMP_TABLE.assignmentId = FOO_Assignment.assignmentId";

	private static final String _FILTER_SQL_COUNT_ASSIGNMENT_WHERE =
		"SELECT COUNT(DISTINCT assignment.assignmentId) AS COUNT_VALUE FROM FOO_Assignment assignment WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "assignment";

	private static final String _FILTER_ENTITY_TABLE = "FOO_Assignment";

	private static final String _ORDER_BY_ENTITY_ALIAS = "assignment.";

	private static final String _ORDER_BY_ENTITY_TABLE = "FOO_Assignment.";
